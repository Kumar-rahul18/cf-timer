(function() {
  ...
  function doneCustomTimer() {
    var custom = { hours: 0, minutes: 0 };
    custom.hours = parseInt(document.getElementById("hours").value, 10) || 0;
    custom.minutes = parseInt(document.getElementById("minutes").value, 10) || 0;
